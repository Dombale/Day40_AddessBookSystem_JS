...
class Contact{
    ...
    set phoneNo(phoneNo){
        let regex = RegExp("^[9]{1}[1]{1}[ ]?[6-9]{1}[0-9]{9}$")
...
let contact1 = new Contact("Priyanka", "Dombale", "Tasgoan", "Sangali", "Maharashtra","416312","91 9437390430","priya@gmail.com");
let contact2 = new Contact("Shushant", "Lad", "Sangli", "sangli", "Maharashtra", "414004", "91 9816561259", "shushant@gmail.com")
